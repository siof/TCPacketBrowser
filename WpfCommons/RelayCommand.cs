...
namespace WpfCommons
{
    public class RelayCommand<T> : ICommand, IDisposable
    {
        ...
        public event EventHandler CanExecuteChanged
        {
            ...
            remove
            {
                if (_canExecute != null)
                {
                    ...
                    //    System.Diagnostics.Debug.WriteLine("Release RelayCommand");
                    _canExecuteChanged -= value;
                    CommandManager.RequerySuggested -= value;
                }
            }
        ...
        {
            EventHandler handler = System.Threading.Interlocked.CompareExchange(ref _canExecuteChanged, null, null);
            if (handler != null)
            {
